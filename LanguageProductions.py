...
declaration1_2 = Production("Declaration1_2")
...
productions = [value, binary_operator, unary_operator,
               expression1_1, expression1_2, expression1,
               expression_1, expression_2, expression_3,
               expression, assignment1, assignment,
               declaration1_2, declaration1, declaration]
